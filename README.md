...
If you [save sites](#saving-sites), they will show in a popup above the searchbar for web addresses. As you type the beginning of the web address, your saved sites will be searched and matching sites shown in the popup. You can filter through saved site results using the up and down arrow keys, and using your ENTER key to open the highlighted site in the popup.  
For example, I save [github.com](https://github.com) to my saved sites. Then, when Stickytab loads, I type "g". The first result in the popup is "github.com", so it is highlighted. I can press ENTER and visit [github.com](https://github.com) without having to type out the entire URL.
...
* Search the web with Google, Bing, or DuckDuckGo (Stickytab is not affiliated with Google, Bing, or DuckDuckGo)
* Save search engine preference locally to your browser
* Save preferred time format locally to your browser
* Easy-access calculator with a button to open Desmos if needed (Stickytab is not affiliated with Desmos)
* Save Desmos calculator preference locally to your browser
